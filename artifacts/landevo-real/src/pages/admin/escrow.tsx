...
import {
  ...
  ArrowUpRight, ArrowDownLeft, Lock, Unlock, Filter, Download,
} from "lucide-react";
...
const escrows = [
  { id: "TXN-9201", property: "Sunset Heights Estate, Ikoyi", buyer: "Aisha Bello", agent: "Jonas Eze", value: 48000000, status: "Pending Release", held: "Oct 18, 2023", commission: "Cleared", docs: 5, daysHeld: 4 },
  { id: "TXN-9104", property: "Maitama Commercial Complex, Abuja", buyer: "Emeka Obi", agent: "Amaka Obi", value: 320000000, status: "Pending Release", held: "Oct 17, 2023", commission: "Cleared", docs: 6, daysHeld: 5 },
  { id: "TXN-8990", property: "Abuja FCT Residential Plot", buyer: "Ngozi Eze", agent: "Alex Sterling", value: 15000000, status: "In Escrow", held: "Oct 15, 2023", commission: "Pending", docs: 3, daysHeld: 7 },
  { id: "TXN-8821", property: "Lekki Phase 1 Corner Plot", buyer: "Samuel Akin", agent: "Kemi Afolabi", value: 25000000, status: "Released", held: "Oct 10, 2023", commission: "Cleared", docs: 4, daysHeld: 0 },
  { id: "TXN-8654", property: "Emerald Valley Estate Phase II", buyer: "Bola Adeyemi", agent: "Musa Ibrahim", value: 18500000, status: "Released", held: "Oct 5, 2023", commission: "Cleared", docs: 4, daysHeld: 0 },
  { id: "TXN-7720", property: "Maitama Gardens Phase II", buyer: "Tunde Adeyemi", agent: "Kemi Afolabi", value: 22000000, status: "Disputed", held: "Sep 28, 2023", commission: "On Hold", docs: 3, daysHeld: 24 },
  { id: "TXN-7615", property: "Hilltop Acreage, Abeokuta", buyer: "Chioma Obi", agent: "Adaeze Nwosu", value: 9800000, status: "Refunded", held: "Sep 20, 2023", commission: "N/A", docs: 2, daysHeld: 0 },
  { id: "TXN-7502", property: "Prime Waterfront Plot, VI", buyer: "Felix Mensah", agent: "Ngozi Adeyemi", value: 245000000, status: "Released", held: "Sep 15, 2023", commission: "Cleared", docs: 8, daysHeld: 0 },
];
            ...
            <div className="rounded-xl border overflow-hidden" style={{ background: "rgba(255,255,255,0.02)", borderColor: "rgba(255,255,255,0.07)" }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5">
                          <p className="text-sm font-semibold text-white max-w-[180px] truncate">{e.property}</p>
                        </td>
                        ...
                        <td className="px-5 py-3.5">
                          <span className={`inline-flex items-center gap-1.5 text-[10px] font-bold px-2.5 py-1 rounded-full border ${statusStyle(e.status)}`}>
                            {e.status}
                          </span>
                        </td>
                        <td className="px-5 py-3.5">
                          <span className={`text-xs font-bold ${e.commission === "Cleared" ? "text-emerald-400" : e.commission === "On Hold" ? "text-red-400" : e.commission === "N/A" ? "text-white/30" : "text-amber-400"}`}>
                            {e.commission}
                          </span>
                        </td>
                        <td className="px-5 py-3.5" onClick={(ev) => ev.stopPropagation()}>
                          {e.status === "Pending Release" && (
                            <button
                              ...
                              style={{ background: releasing === e.id ? "rgba(16,185,129,0.3)" : "rgba(16,185,129,0.15)", color: "#34d399", border: "1px solid rgba(16,185,129,0.25)" }}
                            >
                              {releasing === e.id ? <CheckCircle2 className="w-3.5 h-3.5" /> : <Unlock className="w-3.5 h-3.5" />}
                              {releasing === e.id ? "Released!" : "Release"}
                            </button>
                          )}
                          {e.status === "Disputed" && (
                          ...
                          {e.status === "In Escrow" && (
                            <button className="text-xs font-semibold" style={{ color: "rgba(255,255,255,0.4)" }}>
                              Hold
                            </button>
                          )}
              ...
              {filtered.length === 0 && (
                <div className="py-16 flex flex-col items-center gap-3" style={{ color: "rgba(255,255,255,0.25)" }}>
                  ...
                  <p className="text-sm">No escrow records match this filter</p>
                </div>
              )}
            </div>
          </div>
              ...
              <div className="rounded-xl border sticky top-0" style={{ background: "#13161f", borderColor: "rgba(255,255,255,0.08)" }}>
                ...
                <div className="p-4 space-y-3">
                  {[
                    ...
                    ["Documents", `${selectedEscrow.docs} files`],
