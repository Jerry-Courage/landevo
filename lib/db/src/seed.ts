  ...
  const createdListings = await db.insert(listingsTable).values([
    {
      ...
      description: "Premium 600 sqm residential plot in East Legon. Fully dry, levelled, and ready for immediate development. Valid Land Title Certificate and Lands Commission approval.",
      price: "25000000",
      location: "East Legon, Accra",
      address: "Block 12, Plot 4, East Legon Phase 2",
      city: "East Legon",
      state: "Greater Accra",
      areaSqm: "600",
    ...
    },
    {
      ...
      description: "Prestigious 1,200 sqm plot in Airport Residential with panoramic garden views.",
      price: "48000000",
      location: "Airport Residential, Accra",
      address: "5 Sunset Avenue, Airport Residential",
    ...
    },
    {
      ...
      description: "5,000 sqm industrial-zoned plot in Tema with direct road access to the port.",
      price: "120000000",
      location: "Tema Industrial Area, Greater Accra",
      address: "Plot 7, Tema Industrial Estate",
      city: "Tema",
      state: "Greater Accra",
      areaSqm: "5000",
    ...
    },
    {
      ...
      description: "450 sqm plot in Kasoa with riverfront access.",
      price: "8500000",
      location: "Kasoa, Central Region",
      address: "Riverside Estate, Kasoa",
      city: "Kasoa",
    ...
    },
    {
      ...
      description: "900 sqm plot in Aburi with title deed and gazette.",
      price: "15000000",
      location: "Aburi, Eastern Region",
      address: "Oakwood Estate, Aburi",
      city: "Aburi",
    ...
    },
    {
      ...
      description: "2,400 sqm prime commercial land on the Cantonments waterfront.",
      price: "245000000",
      location: "Cantonments, Accra",
      address: "10 Marina Road, Cantonments",
      city: "Cantonments",
      state: "Greater Accra",
      areaSqm: "2400",
      propertyType: "commercial" as const,
